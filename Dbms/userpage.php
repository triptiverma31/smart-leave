...
<div id="wrapper">
            ...
            <section id="content" class="main">
								...
								<div class="box alt">
									<div class="row uniform">
										...
										<div class="2u" style="color:red"><a href="" >Cacel Leave<span class="image fit" ><img src="images/cancel.svg" alt="cancel leave" title="Cancel leave" /></span></a></div>
      ...
      <footer id="footer">
            <section>
              ...
              <ul class="actions">
                <li><a href="login.php" class="button">Learn More</a></li>
              </ul>
            </section>
            <section>
              <h2>Contact Us</h2>
