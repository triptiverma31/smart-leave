...
var check = function() {
  if (document.getElementById('password').value ==
    ...
    && document.formname.password.value.length > 3; // Adding additional validation here
							...
							<section id="content" class="main">
									...
									<form name="formname" action="insertreg.php" method="post">
										...
										<div class="4u 12u$(small)">
												...
												<br>
										<div class="12u$">
										<select class="demo-categoery" name="designation">
										...
										<option value="g_faculty">Other</option>
											...
											<div class="12u$">
										<select class="demo-categoery" name="department">
										...
										<div class="12u$" >
										<input type="password" name="password" id="password" onKeyUp="validate()" placeholder="Password" required></div>
										<div class="12u">
