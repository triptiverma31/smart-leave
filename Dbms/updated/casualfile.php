<?php
 ...
 $lname = mysqli_real_escape_string($link, $_POST['lname']);
  ...
  $dateofapply= mysqli_real_escape_string($link, $_POST['dateofapply']);
    ...
    $sql = "INSERT INTO  casual_leave(Empid,fname,lname,sex,deptname,designation,leave_from,leave_to,duration,reason,add_leave,dateofapply) VALUES
 ('$emp_id', '$fname', '$lname', '$sex', '$department', '$designation', '$from', '$to','$duration', '$PurposeofLeave','$Addresswhenonleave','$dateofapply')";

    if(mysqli_query($link, $sql))
{
    echo "You have sucessfully Applied for Casual Leave." ;
