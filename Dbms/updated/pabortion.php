...
<?php
        ...
        $selectvolunteer=mysql_query("(SELECT * FROM abortion_leave where status='pending')");
 ...
 $ustatus=$volunteerrow['status'];
                    ...
                    ?>
<form action="sanction_abortion.php" method="POST">
  <table width="100%">
<tr>
<td><strong><input type="text" size="8px" name="empid" value="<?php echo $uid; ?>"></strong></td>
...
<td><strong><input type="text" size="6px" name="remained_leave" value="<?php echo $remainedleave; ?>"></strong></td>
