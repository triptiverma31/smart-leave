...
<?php
        ...
        $selectvolunteer=mysql_query("(SELECT * FROM casual_leave where status='pending')");
...
$remainedleave=$volunteerrow['remained_leave'];
                    ...
                    ?>
<form action="sanction_casual.php" method="post">
  <table width="100%">
<tr>
...
<td><strong><input type="text" size="6px" name="duration" value="<?php echo $udu; ?>"></strong></td>
...
<option value="pending" name="pending">still pending</option>
<option value="decline" name="decline">decline</option>
<option value="Sanctioned" name="sanctioned">Sanctioned</option>
</select>
</td>
<td>
